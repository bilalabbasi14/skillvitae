    ...
    <div className="relative flex flex-col min-h-screen bg-zinc-950 text-zinc-100 selection:bg-indigo-500 selection:text-white overflow-hidden">
      ...
      <footer className="w-full border-t border-zinc-900/30 py-8 text-center text-xs text-zinc-600 relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-zinc-500">&copy; {new Date().getFullYear()} SkillVitae. Everything runs locally in your browser. No data leaves your machine.</p>
          <a
            href="https://github.com/bilalabbasi14"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-zinc-500 hover:text-zinc-300 transition-all duration-300 p-2 rounded-xl glass hover:bg-zinc-800/25 border border-transparent hover:border-zinc-800"
          ...
          >
            ...
            <span className="font-semibold text-[11px] tracking-wider uppercase">GitHub</span>
          </a>
        </div>
      </footer>
    </div>
